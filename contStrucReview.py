...
'''
for Loop - used to iterate over a sequence(ex. a list or range of items)
Iteration - every time you repeat something
'''
...
'''
while Loops - a Loop that continues running as long its condition is True
